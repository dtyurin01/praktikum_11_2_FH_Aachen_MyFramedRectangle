...
namespace Catch {
    ...
    public:
        ...
        static int& get_array_new_count() {
            static int array_new_count = 0;
            return array_new_count;
        }
        static int& get_delete_count() {
            static int delete_count = 0;
            return delete_count;
        }
        static int& get_array_delete_count() {
            static int array_delete_count = 0;
            return array_delete_count;
        }
        static void run() {
            ...
            get_new_count() = 0;
            get_array_new_count() = 0;
            get_delete_count() = 0;
            get_array_delete_count() = 0;
